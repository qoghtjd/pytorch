...
// This forward declaration matching the declaration of __assert_fail exactly
// how it is in glibc in case parts of the program are compiled with different
// NDEBUG settings. Otherwise we might get 'ambiguous declaration' error.
// Note: On ROCm - this declaration serves for host side compilation.
void __assert_fail(
